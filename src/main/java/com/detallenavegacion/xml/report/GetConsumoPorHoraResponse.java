 ...
 *         &lt;element name="lista" type="{http://www.detallenavegacion.com/xml/report}Reporte" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getConsumoPorHoraResponse")
public class GetConsumoPorHoraResponse {

    protected int code;
    @XmlElement(required = true)
    protected String description;
    protected long total;
    protected List<Reporte> lista;
